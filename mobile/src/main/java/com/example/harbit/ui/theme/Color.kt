...
// Chart colors for activity distribution (using theme colors)
val SedentaryColor = Color(0xFF515E7D) // tertiary
val WalkingColor = Color(0xFF4A6366) // secondary
val StandingColor = Color(0xFF006972) // primary
val ExerciseColor = Color(0xFFBA1A1A) // error
val OtherColor = Color(0xFF6F797A) // outline

// Status colors using theme system
val SuccessColor = Color(0xFF4A6366) // secondary
val WarningColor = Color(0xFF515E7D) // tertiary
val ErrorColor = Color(0xFFBA1A1A) // error
